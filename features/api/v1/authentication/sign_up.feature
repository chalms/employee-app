Feature: Sign Up
    ...
    Scenario: Successful sign up
      ...
      """
      And the JSON response at "authentication_token" should be a string
      And the JSON response at "email" should be "user"
      And the JSON response at "first_name" should be "Saul"
      And the JSON response at "last_name" should be "Hudson"
      Given I keep the JSON response at "authentication_token" as "AUTH_TOKEN"
