...
function launchToDo(auth){
    $(function() {
        ...
        var TemplateStore = {
          parse: function(model, jqXHR) {
            if (jqXHR.status == 200 && jqXHR.readyState == 4) {
              TemplateStore[model.url()] = jqXHR.responseText;
              model.render();
            }
          }
        };
        ...
        TaskObj = {
           ...
           //... is a list tag.
            ...
            events: {
             ...
             url: function() {
                return 'assets/javascripts/templates/task-template.html';
            },
            ...
            render: function() {
                ...
                this.$el.html(_.template(TemplateStore[this.url()], this.model.attributes));
            ...
            initialize: function() {
                ...
                this.on('error', TemplateStore.parse, this);
            },
        ...
        _.extend(TaskObj, Backbone.Events); 
        var TaskView = Backbone.View.extend(TaskObj);
        ...
        _.extend(AppObj, Backbone.Events); 
        var AppView = Backbone.View.extend(AppObj);
        var App = new AppView;
    })
}; 