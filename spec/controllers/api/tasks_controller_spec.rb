...
RSpec.describe Api::TasksController, :type => :controller do
  ...
  # Api::Task. As you add validations to Api::Task, be sure to
  ...
  # Api::TasksController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all api_tasks as @api_tasks" do
      task = Api::Task.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:api_tasks)).to eq([task])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested api_task as @api_task" do
      ...
      expect(assigns(:api_task)).to eq(task)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new api_task as @api_task" do
      ...
      expect(assigns(:api_task)).to be_a_new(Api::Task)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created api_task as @api_task" do
        post :create, {:api_task => valid_attributes}, valid_session
        expect(assigns(:api_task)).to be_a(Api::Task)
        expect(assigns(:api_task)).to be_persisted
      end

      it "redirects to the created api_task" do
        post :create, {:api_task => valid_attributes}, valid_session
        expect(response).to redirect_to(Api::Task.last)
      end
    end

    describe "with invalid params" do
      it "assigns a newly created but unsaved api_task as @api_task" do
        post :create, {:api_task => invalid_attributes}, valid_session
        expect(assigns(:api_task)).to be_a_new(Api::Task)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested api_task" do
        task = Api::Task.create! valid_attributes
        put :update, {:id => task.to_param, :api_task => new_attributes}, valid_session
        task.reload
    ...
    describe "with invalid params" do
      it "assigns the api_task as @api_task" do
        task = Api::Task.create! valid_attributes
        put :update, {:id => task.to_param, :api_task => invalid_attributes}, valid_session
        expect(assigns(:api_task)).to eq(task)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the api_tasks list" do
      task = Api::Task.create! valid_attributes
      delete :destroy, {:id => task.to_param}, valid_session
      expect(response).to redirect_to(api_tasks_url)
    end
  end
